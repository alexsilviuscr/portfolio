  ...
  return (
    ...
    >
      <div className={`${styles.contactForm}`}>
        <form
          name="Alex Silviu Contact Form"
          className={`${styles.form} flex flex-col gap-8`}
          action="https://getform.io/f/5f5bdafe-53bc-4721-98c0-f4e160cda0f2"
          method="POST"
        >
        ...
        <div className={`${styles.contactInfo}`}>
          <div className={`${styles.contactList} flex flex-col gap-8`}>
            ...
            <li
              className={`${styles.listItem} flex flex-row items-center gap-4`}
            >
              <span>
              ...
              <span className="flex flex-col gap-1">
                ...
                <p className={styles.subtitle}>Timisoara, Romania</p>
              </span>
            </li>
